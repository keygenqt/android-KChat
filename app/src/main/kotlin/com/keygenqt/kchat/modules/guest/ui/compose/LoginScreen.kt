...
import com.keygenqt.kchat.modules.common.navigation.GuestNavScreen
...
import com.keygenqt.kchat.modules.guest.ui.form.states.FormStatesLogin.Email
import com.keygenqt.kchat.modules.guest.ui.form.states.FormStatesLogin.Password
...
fun LoginForm(
    ...
    LaunchedEffect(Unit) {
        scope.launch {
            delay(10)
            onNavigationEvent(LoginEvents.ClearViewModel)
